...
syn match cssTextProp contained "\<text-\(align-last\|autospace\|justify\|outline\|shadow\|underline-position\|wrap\|emphasis\(-\(color\|position\|style\)\)\=\|decoration-\(color\|line\|skip\|style\)\)\>"
syn match cssTextProp contained "\<overflow-x\>"
